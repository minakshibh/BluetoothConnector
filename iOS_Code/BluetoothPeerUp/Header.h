...
//  HangmanPeerUp
//
//  Created by Krishna-Mac on 08/12/15.
//  Copyright (c) 2015 Apple, Inc. All rights reserved.
//

#ifndef HangmanPeerUp_Header_h
#define HangmanPeerUp_Header_h

#pragma mark All Alert Titles
#define AlertTitle @"Hangman Peerup"
#define AlerttTitleComplete @"Upload Complete"
#define AlerttTitleFailure @"Upload Failure"
...
#define AlertMessageConfirmPasswordRequired @"Please enter password to confirm."
...
#define BrowseButtontext @"Browse"

#pragma mark ScanViewController Static Text

#define NotConnectedToAnyDevice @"You are currently not connected to any device."
